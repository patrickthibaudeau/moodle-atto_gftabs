YUI.add('moodle-atto_gftabs-button', function (Y, NAME) {
...
// along with Moodle.  If not, see <http://www.gnu.org/licenses/>.
    ...
    /**
     * @module moodle-atto_gftabs-button
     */

    /**
     * Atto text editor gftabs plugin.
     *
     * @namespace M.atto_gftabs
     * @class button
     * @extends M.editor_atto.EditorPlugin
     */

    Y.namespace('M.atto_gftabs').Button = Y.Base.create('button', Y.M.editor_atto.EditorPlugin, [], {
        initializer: function () {

            // Check whether we are editing a label within the Glendon course format.
            var form = this.get('host').editor.ancestor('body#page-mod-label-mod.format-glendon');
